...
if true; then
  model_name=Bert_base_Rdrop_T_cs_cr
  lr=1e-3
  lr_bert=2e-5  
  lr_tran=1e-4
  ...
  nohup python -u train_bert_rdrop_t_cs_cr.py \
    --notes "[使用 Coreference 信息]" \
    --train_set ../data/train_cr.json \
    --train_set_save ../data/prepro_data/train_BERT_uncased_cr.pkl \
    --dev_set ../data/dev_cr.json \
    --dev_set_save ../data/prepro_data/dev_BERT_uncased_cr.pkl \
    --test_set ../data/test.json \
    --test_set_save ../data/prepro_data/test_BERT_uncased_cr.pkl \
