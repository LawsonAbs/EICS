...
def train(opt):
    ...
    for epoch in range(start_epoch, opt.epoch + 1):
        ...
        for ii, d in enumerate(train_loader): # 送入模型的是一个batch 的数据
            ...
            loss_1 = cal_focal_loss(predictions_bert,relation_multi_label,opt.gamma,relation_mask)
...
if __name__ == '__main__':
    ...
    wandb.init(project="train_rrcs", entity="lawsonabs")
