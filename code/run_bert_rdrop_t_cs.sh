...
if true; then
  model_name=RoBerta_large_Rdrop_T_cs
  lr=1e-3
  lr_bert=2e-5  
  lr_tran=1e-4
  ...
  nohup python -u train_bert_rdrop_t_cs.py \
    --notes "使用roberta-large" \
    --train_set ../data/train.json \
    --train_set_save ../data/prepro_data/train_BERT_roberta.pkl \
    --dev_set ../data/dev.json \
    --dev_set_save ../data/prepro_data/dev_BERT_roberta.pkl \
