...
from config import *
from data_RGCN_mention import DGLREDataset, DGLREDataloader, BERTDGLREDataset  # 这是从data.py 中引入几个类
from models.BERT_rdrop_t_cs_mention import  BERT_T
from evaluate_bert_rdrop_t_cs_mention import eval
    ...
    for epoch in range(start_epoch, opt.epoch + 1):
        ...
        for ii, d in enumerate(train_loader): # 送入模型的是一个batch 的数据
            ...
            predictions_bert_1 = bert_T(words=d['context_idxs'],
                                ...
                                entity2mention_batch=d['entity2mention_batch'],
...
if __name__ == '__main__':
    ...
    wandb.init(project="train_bert_rdrop_t_cs_mention", entity="lawsonabs")
